...
ImageBoardDAO boardBAO = new ImageBoardDAO();
ImageBoard board = boardBAO.select(Integer.parseInt(request.getParameter("board_id")));
...
<div class="container">
  <form>
  <input type="text" id="board_id" name="board_id" value="<%=board.getBoard_id() %>" hidden>
