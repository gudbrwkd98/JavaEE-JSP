...
QnA qna = qnaDAO.select(Integer.parseInt(request.getParameter("notice_id")));
...
<div class="container">
  <form>
    <input type="text" id="qna_id" name="qna_id" value="<%=qna.getQna_id()%>" hidden>
  	<input type="text" name = "team" value="<%=qna.getTeam()%>" hidden>
  	<input type="text" name = "rank" value="<%=qna.getRank()%>" hidden>
  	<input type="text"  name = "depth" value = "<%=qna.getDepth() %>" hidden>
