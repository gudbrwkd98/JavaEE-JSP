...
<body>
	...
	<%
		/*
		JNDI 란 ? 
		Java Naming Directory Interface : 어떤 정보를 프로그래밍 언어인 자바코드에 넣지말고 외부의 xml 과 같은 자원으로 관리하는 방법 
		(즉 java 코드안에 설정정보를 넣지말고 코드 밖으로 빼서 유지 관리하자!)  
		*/
		...
		Connection conn = ds.getConnection(); //커넥션풀로 하나의 커넥션을 얻는 작업!!
